...
List<DashBoard2DataModel> courseInProgressList() {
  List<DashBoard2DataModel> _courseInProgressList = [
    ...
    DashBoard2DataModel(
      ...
      image: 'images/webDashboard2/web_design.jpg',
      progress: 62,
    ),
    DashBoard2DataModel(
      name: 'UI Design',
      ...
      progress: 50,
      image: 'images/webDashboard2/ui_design.jpg',
    ),
  ];
...
List<DashBoard2DataModel> categoryList() {
  List<DashBoard2DataModel> _categoryList = [
    DashBoard2DataModel(
      name: 'UI/UX Design',
      courseCount: 18,
      image: 'images/webDashboard2/ui_category.jpg',
    ),
    DashBoard2DataModel(
      name: 'Marketing',
      courseCount: 34,
      image: 'images/webDashboard2/marketing.jpg',
    ),
    DashBoard2DataModel(
      name: 'Development',
      courseCount: 126,
    ...
    DashBoard2DataModel(
      name: 'Business',
      courseCount: 213,
      image: 'images/webDashboard2/business.jpg',
    ),
    DashBoard2DataModel(
