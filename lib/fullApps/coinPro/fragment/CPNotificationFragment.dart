  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(onPressed: () {}, icon: Icon(Icons.settings, color: appStore.isDarkModeOn ? white : black, size: 24)),
        ],
      ),
                          ...
                          children: [
                            Text(
                              ...
                              style: TextStyle(
                                ...
                                fontStyle: FontStyle.normal,
                                fontSize: 14,
                                color: markAllRead ? Colors.grey : Colors.grey.withOpacity(0.6),
                              ),
                            ),
