          ...
          child: Column(
            ...
            children: [
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(color: appStore.isDarkModeOn ? transparentColor : Color(0x4d908f8f), width: 1),
                          ),
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.start,
                            crossAxisAlignment: CrossAxisAlignment.center,
                            ...
                            children: [
                              ...
                              Container(
                                decoration: boxDecorationWithRoundedCorners(
                                    border: Border.all(color: selectCardIndex == index ? Colors.transparent : gray),
                                    boxShape: BoxShape.circle,
                                    backgroundColor: selectCardIndex == index ? CPPrimaryColor : Colors.transparent),
                                height: selectCardIndex == index ? 12 : 15,
                                width: selectCardIndex == index ? 12 : 15,
                              )
                            ],
                          ),
                        ).onTap(
              ...
              MaterialButton(
                ...
                child: Text("Next", style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, fontStyle: FontStyle.normal)),
